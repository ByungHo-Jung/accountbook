    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        et_date1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog dialog = new DatePickerDialog(detail.this, myDatePicker, myCalendar1.get(Calendar.YEAR), myCalendar1.get(Calendar.MONTH), myCalendar1.get(Calendar.DAY_OF_MONTH));
                dialog.show();
            }
        });
